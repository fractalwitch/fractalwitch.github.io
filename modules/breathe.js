...
function BreatheWithMe() {
  const [breathPhase, setBreathPhase] = reactExports.useState("inhale");
  const [progress, setProgress] = reactExports.useState(0);
  const [particles, setParticles] = reactExports.useState([]);
  const [orbitals, setOrbitals] = reactExports.useState([]);
  const phases = {
    inhale: 5e3,
    hold: 3e3,
    exhale: 7e3,
  ...
  const glowIntensity = breathPhase === "hold" ? 1 : breathPhase === "inhale" ? 0.6 + progress * 0.4 : breathPhase === "exhale" ? 1 - progress * 0.4 : 0.6;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
    ...
    particles.map((p) => {
      const yOffset = breathPhase === "inhale" ? -progress * 15 : breathPhase === "exhale" ? progress * 10 : 0;
    ...
    orbitals.map((o) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
          position: "absolute",
...
client.createRoot(document.getElementById("root")).render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BreatheWithMe, {}) })
);
